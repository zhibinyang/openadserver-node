...
CREATE TABLE IF NOT EXISTS request_events_kafka (
    ...
    'format' = 'protobuf',
    'protobuf.message-class-name' = 'events.RequestEvent',
    'protobuf.message-class-path' = '/opt/flink/protobuf/events.jar',
...
CREATE TABLE IF NOT EXISTS ad_events_kafka (
    ...
    'format' = 'protobuf',
    'protobuf.message-class-name' = 'events.AdEvent',
    'protobuf.message-class-path' = '/opt/flink/protobuf/events.jar',
    'scan.startup.mode' = 'latest-offset'
);
...
CREATE TABLE IF NOT EXISTS impression_events_kafka (
    ...
    'format' = 'protobuf',
    'protobuf.message-class-name' = 'events.ImpressionEvent',
    'protobuf.message-class-path' = '/opt/flink/protobuf/events.jar',
    'scan.startup.mode' = 'latest-offset'
);
...
CREATE TABLE IF NOT EXISTS click_events_kafka (
    ...
    'format' = 'protobuf',
    'protobuf.message-class-name' = 'events.ClickEvent',
    'protobuf.message-class-path' = '/opt/flink/protobuf/events.jar',
    'scan.startup.mode' = 'latest-offset'
);
...
CREATE TABLE IF NOT EXISTS conversion_events_kafka (
    ...
    'format' = 'protobuf',
    'protobuf.message-class-name' = 'events.ConversionEvent',
    'protobuf.message-class-path' = '/opt/flink/protobuf/events.jar',
    'scan.startup.mode' = 'latest-offset'
);
...
CREATE TABLE IF NOT EXISTS video_vtr_events_kafka (
    ...
    'format' = 'protobuf',
    'protobuf.message-class-name' = 'events.VideoVTREvent',
    'protobuf.message-class-path' = '/opt/flink/protobuf/events.jar',
    'scan.startup.mode' = 'latest-offset'
);
...
-- Request Events Sink
CREATE TABLE IF NOT EXISTS request_events_ch (
    request_id STRING,
...
-- Ad Events Sink
CREATE TABLE IF NOT EXISTS ad_events_ch (
    request_id STRING,
    impression_id INT,
    click_id STRING,
    campaign_id INT,
...
CREATE TABLE IF NOT EXISTS ad_impression_joined_ch (
    click_id STRING,
    request_id STRING,
    impression_id INT,
    campaign_id INT,
    ...
    'url' = 'http://clickhouse:8123',
    'database' = 'default',
    'table' = 'ad_impression_joined',
    'format' = 'json'
);

-- Ad + Click Joined Sink
CREATE TABLE IF NOT EXISTS ad_click_joined_ch (
    click_id STRING,
    request_id STRING,
    impression_id INT,
    campaign_id INT,
    ...
    'url' = 'http://clickhouse:8123',
    'database' = 'default',
    'table' = 'ad_click_joined',
    'format' = 'json'
);

-- Ad + Conversion Joined Sink
CREATE TABLE IF NOT EXISTS ad_conversion_joined_ch (
    click_id STRING,
    request_id STRING,
    impression_id INT,
    campaign_id INT,
    ...
    'url' = 'http://clickhouse:8123',
    'database' = 'default',
    'table' = 'ad_conversion_joined',
    'format' = 'json'
);

-- Video VTR Events Sink
CREATE TABLE IF NOT EXISTS video_vtr_events_ch (
    click_id STRING,
    event_time TIMESTAMP(3),
    event_type STRING,
    progress_percent INT
    ...
    'url' = 'http://clickhouse:8123',
    'database' = 'default',
    'table' = 'video_vtr_events',
    'format' = 'json'
);

-- Ad + Video VTR Joined Sink
CREATE TABLE IF NOT EXISTS ad_video_vtr_joined_ch (
    click_id STRING,
    request_id STRING,
    impression_id INT,
    campaign_id INT,
...
-- Job 1: Request Events → ClickHouse
INSERT INTO request_events_ch
SELECT
    request_id,
...
-- Job 2: Ad Events → ClickHouse
INSERT INTO ad_events_ch
SELECT
    request_id,
    impression_id,
    click_id,
...
-- Job 3: Ad + Impression JOIN → ClickHouse
-- Using temporal join with state retention
INSERT INTO ad_impression_joined_ch
SELECT
    a.click_id,
    a.request_id,
    a.impression_id,
...
-- Job 4: Ad + Click JOIN → ClickHouse
INSERT INTO ad_click_joined_ch
SELECT
    a.click_id,
    a.request_id,
    a.impression_id,
...
FROM ad_events_kafka AS a
INNER JOIN click_events_kafka FOR SYSTEM_TIME AS OF a.`timestamp` AS c
ON a.click_id = c.click_id;

-- Job 5: Ad + Conversion JOIN → ClickHouse
INSERT INTO ad_conversion_joined_ch
SELECT
    a.click_id,
    a.request_id,
    a.impression_id,
    ...
    cv.conversion_type
FROM ad_events_kafka AS a
INNER JOIN conversion_events_kafka FOR SYSTEM_TIME AS OF a.`timestamp` AS cv
ON a.click_id = cv.click_id;

-- Job 6: Video VTR Events → ClickHouse
INSERT INTO video_vtr_events_ch
SELECT
    click_id,
    TO_TIMESTAMP_LTZ(event_time, 3) AS event_time,
    event_type,
...
-- Job 7: Ad + Video VTR JOIN → ClickHouse
INSERT INTO ad_video_vtr_joined_ch
SELECT
    a.click_id,
    a.request_id,
    a.impression_id,
    ...
    v.progress_percent
FROM ad_events_kafka AS a
INNER JOIN video_vtr_events_kafka FOR SYSTEM_TIME AS OF a.`timestamp` AS v
